...
class CrossModalFPNDecoder(nn.Module):
    ...
    def forward_features(self, features, text_features, poses, memory, weight_index, nf):
        # nf: num_frames
        ...
        text_features = text_features[:, weight_index, :].unsqueeze(1)
        text_masks = text_masks[weight_index, :].unsqueeze(0)
        text_pos = text_pos[:, weight_index, :].unsqueeze(1)
    ...
    def forward(self, features, text_features, pos, memory, weight_index, nf):
        ...
        """
        y = self.forward_features(features, text_features, pos, memory, weight_index, nf)
