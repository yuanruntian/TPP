...
def get_args_parser():
    parser = argparse.ArgumentParser('TPP training and inference scripts.', add_help=False)
    ...
    parser.add_argument('--batch_size', default=1, type=int)  ## batchsize default=1
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default='custom', help='Dataset name') 
    parser.add_argument('--custom_path', type=str, default='/root/data')
    ...
    parser.add_argument('--ngpu', default=2, type=int, help='gpu number when inference')
